  ...
  return (
    <div>
      ...
      <div className='lg:pt-6'>
        ...
        <ul className='lg:pt-4 list-disc'>
      ...
      <div className='lg:pt-6'>
        ...
        <ol type='1'>
          ...
          <li className='font-bold text-2xl lg:pt-4'>3. Website revamp</li>
          ...
          <li className='font-bold text-2xl lg:pt-4'>4. Social media optimization</li>
          ...
          <li className='font-bold text-2xl lg:pt-4'>5. Analytics and reporting</li>
      ...
      <div className='lg:pt-6'>
        ...
        <div className='flex gap-4 lg:pt-28'>
